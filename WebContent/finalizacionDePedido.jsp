...
<html>
	...
	<body>
		...
		<% 	HttpSession sesion = request.getSession(true);
			...
			<p align="center"><b><font face="calibri" color="black" size="6">MUCHAS GRACIAS PRO SU COMPRA</font></b></p>
			<p align="center"><b><font face="calibri" color="black" size="2">Recuerde que debe pasar a retirar y abonar el pedido en tres dás hábiles por el local informando el siguiente número de pedido: <%=nro_pedido%>.</font></b></p>
