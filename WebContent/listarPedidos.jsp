...
<html>
	...
	<body style="weigth:800px !important">
	   ...
	   <hr/>
		...
		<hr/>
		<div class="alert alert-danger" role="alert" id="mensajeError" hidden="true">Ocurri� un error interno</div>
		<div class="alert alert-primary" role="alert" id="mensajeOkPreparacion" hidden="true">Preparaci�n registrada con �xito</div>
		<div class="alert alert-primary" role="alert" id="mensajeOkEntrega" hidden="true">Entrega registrada con �xito</div>
		<% 	
