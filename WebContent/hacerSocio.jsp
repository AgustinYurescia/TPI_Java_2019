	   	...
	   	<form action="ControladorCliente" method="post">
	   		<div class="form-row">
    			...
    			<div class="form group col-md-2">
      				<button type="submit" class="btn btn-primary" name="accion" value="hacer_socio" style="width: 175px" onclick="return validacion_cliente();">Hacer Socio</button>
    			</div>
  			</div>
	   	</form>
		...
		<form action="ControladorCliente" method="post">
  			...
  			<div class="form-row">
    			<div class="form-group col-md-6">
      				...
      				<input type="hidden" class="form-control" id="usuario" name="usuario" value=<%=cliente.getCliente_usuario()%> disabled>
    			</div>
    			<div class="form-group col-md-6">
      				<!-- <label for="contrasena">Contraseña</label> -->
      				<input type="hidden" id="contrasena" name="contrasena" class="form-control" value=<%=cliente.getCliente_contrasena()%> disabled>
    			</div>
  			</div>
