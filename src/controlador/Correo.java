...
public class Correo {
	...
	public void enviar_mail_confirmacion(String destinatario, int nro_pedido) throws IOException, MessagingException {
		...
		try {
			...
			messageBodyPart.setText("GRACIAS POR SU COMPRA. RECUERDE QUE DEBE PASAR A RETIRAR Y ABONAR EL PEDIDO EN TRES DÍAS HÁBILES O CUANDO SE LO NOTIFIQUE POR EMAIL. SU NÚMERO DE PEDIDO ES " + nro_pedido);
